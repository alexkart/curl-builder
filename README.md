# curl-builder [![Build status](https://github.com/alexkart/curl-builder/actions/workflows/php.yml/badge.svg?event=push)](https://github.com/alexkart/curl-builder/actions) [![Code Coverage](https://scrutinizer-ci.com/g/alexkart/curl-builder/badges/coverage.png?b=master)](https://scrutinizer-ci.com/g/alexkart/curl-builder/?branch=master)
